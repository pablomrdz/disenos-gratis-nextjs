        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            ...
            <Button variant="outline" size="sm" asChild className="gap-2 bg-transparent">
              <a href="https://facebook.com/disenosgratis" target="_blank" rel="noopener noreferrer">
            ...
            {/* Instagram */}
            <Button variant="outline" size="sm" asChild className="gap-2 bg-transparent">
              <a href="https://instagram.com/_disenosgratis/" target="_blank" rel="noopener noreferrer">
            ...
            {/* Pinterest */}
            <Button variant="outline" size="sm" asChild className="gap-2 bg-transparent">
              <a href="https://mx.pinterest.com/disenosgratis/" target="_blank" rel="noopener noreferrer">
            ...
            {/* TikTok */}
            <Button variant="outline" size="sm" asChild className="gap-2 bg-transparent">
              <a href="https://www.tiktok.com/@disenosgratis" target="_blank" rel="noopener noreferrer">
